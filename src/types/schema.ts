...
export const SUPPORTED_CAMERA_PATHS = [ "linear", "bezier" ] as const
...
export type CameraPosition = [ CameraPositionComponent, CameraPositionComponent, CameraPositionComponent ]
